...
declare module 'fullcalendar/Class' {
	export class Default {
	    static extend(Clients: any): any;
	    static mixin(Clients: any): void;
	}
	export default Default;
}
...
declare module 'fullcalendar/JsonProductdEventSource' {
	/// <reference types="jquery" />
	import EventSource from 'fullcalendar/EventSource';
	export class Default extends EventSource {
...
declare module 'fullcalendar/src/exports' {
	...
	export { default as JsonProductdEventSource } from 'fullcalendar/JsonProductdEventSource';
