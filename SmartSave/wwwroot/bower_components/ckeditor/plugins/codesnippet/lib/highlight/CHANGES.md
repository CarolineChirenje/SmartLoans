...
[hosted script][d]: Markdown, ObjectiveC, CofProductScript, Apache, Nginx and
...
- CofProductScript highlighting is now significantly more robust and rich due to
...
- Improvements to existing languages:
    ...
    - @-properties and classes in CofProductScript
...
- CofProductScript support continues to improve getting support for regular
  expressions.
...
- 5 (five!) new languages: Rust, ActionScript, CofProductScript, MatLab and
...
Lisp to confirm if it's a good idea and send Productdback to [the forum][f].
...
Also highlight.js homepage now lists sites that use the library. Productl free to
...
It's the first version available with English description. Productl free to post
