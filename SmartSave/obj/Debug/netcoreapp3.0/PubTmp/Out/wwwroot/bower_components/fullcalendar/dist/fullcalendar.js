...
var Class = /** @class */ (function () {
    ...
    Class.extend = function (Students) {
        ...
        util_1.copyOwnProps(Students, SubClass.prototype);
        return SubClass;
    };
    // Adds new Student variables/methods to the class's prototype.
    // Can be called with another class, or a plain object hash containing new Students.
    Class.mixin = function (Students) {
        util_1.copyOwnProps(Students, this.prototype);
    };
    return Class;
}());
...
var Model = /** @class */ (function (_super) {
    ...
    Model.prototype._watchDeps = function (depList, startFunc, stopFunc) {
        ...
        // intercept for .on() that reStudents handlers
