    ...
    public partial class FiscalYears : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 36, "FiscalYear", "fa fa-calendar", "FiscalYear", "Fiscal Years", true, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 147, DateTimeKind.Local).AddTicks(6002), 4, true, 35 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 3, true, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 158, DateTimeKind.Local).AddTicks(2890), "Active" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 151, null, true, false, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(3801), "Delete Fiscal Year" },
                    { 150, null, true, false, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(3796), "View Fiscal Year" },
                    { 148, null, true, false, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(3785), "Add Fiscal Year" },
                    { 149, null, true, false, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(3790), "Update Fiscal Year" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 148, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(9333), 148, 1 },
                    { 149, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(9337), 149, 1 },
                    { 150, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(9342), 150, 1 },
                    { 151, "SuperUser", new DateTime(2022, 4, 9, 16, 28, 45, 97, DateTimeKind.Local).AddTicks(9346), 151, 1 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_LoanFinances_ProductID",
                table: "LoanFinances",
                column: "ProductID");

            migrationBuilder.CreateIndex(
                name: "IX_Companies_FiscalYearID",
                table: "Companies",
                column: "FiscalYearID");

            migrationBuilder.AddForeignKey(
                name: "FK_Companies_FiscalYears_FiscalYearID",
                table: "Companies",
                column: "FiscalYearID",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_LoanFinances_Products_ProductID",
                table: "LoanFinances",
                column: "ProductID",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoanFiscalID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "LastChangedDate",
                value: new DateTime(2022, 4, 9, 15, 17, 13, 531, DateTimeKind.Local).AddTicks(440));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                column: "LastChangedDate",
                value: new DateTime(2022, 4, 9, 15, 17, 13, 531, DateTimeKind.Local).AddTicks(756));
